<template>
    <div class="wrap">
        <div v-if="!isLogin">
            <div @click="sendKakaoUrl">
            <!-- <div class="google-btn" @click="sendKakaoUrl"> -->
                <!-- <p class="btn-text"><b>Sign in with kakao</b></p> -->
...
export default {
    ...
    setup() {
        ...
        const state = reactive({
            kakaoUrl:
                "http://localhost:8080/oauth2/authorize/kakao?redirect_uri=http://localhost:8081/oauth2/redirect",
            user: {
                name: "",
                imageUrl: "",
                email: "",
        ...
        const sendKakaoUrl = () => {
            console.log("sendKakaoUrl");
            location.href = state.kakaoUrl;
        };
        const handleLogout = () => {
            console.log("logout");
