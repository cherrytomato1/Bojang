      ...
      >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <v-img
                :src="'https://i5a508.p.ssafy.io:8081/api/store/downloadFile/' + $store.getters.myStore.image"
                max-height="256"
                max-width="194"
              />
            </td>
...
export default {
  ...
  methods:{
    updateComment(){
      axios({
        method:'post',
        url:'https://i5a508.p.ssafy.io:8081/api/store/comment',
        headers:{
    ...
    async submit() {
      ...
      try {
        const { data } = await axios.post(
          "https://i5a508.p.ssafy.io:8081/api/store/image",
          formData,
          {
            headers: {
